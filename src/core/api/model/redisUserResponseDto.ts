 ...
 */
import type { RedisUserResponseDtoRole } from './redisUserResponseDtoRole';

export interface RedisUserResponseDto {
  /** Unique user identifier (UUID) */
  userId: string;
  /** User name */
  name: string;
  /** Last active timestamp (Unix timestamp in milliseconds) */
  lastActive: number;
  /** User role */
  role: RedisUserResponseDtoRole;
  /** Array of recently visited room IDs (max 10) */
  recentRooms?: string[];
}
