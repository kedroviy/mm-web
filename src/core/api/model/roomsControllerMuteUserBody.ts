 ...
 */
import type { RoomsControllerMuteUserBodyDurationMinutes } from './roomsControllerMuteUserBodyDurationMinutes';

export type RoomsControllerMuteUserBody = {
  /** Mute duration in minutes */
  durationMinutes: RoomsControllerMuteUserBodyDurationMinutes;
};
