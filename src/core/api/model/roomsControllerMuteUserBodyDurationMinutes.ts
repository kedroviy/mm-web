 ...
 */
export type RoomsControllerMuteUserBodyDurationMinutes = typeof RoomsControllerMuteUserBodyDurationMinutes[keyof typeof RoomsControllerMuteUserBodyDurationMinutes];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RoomsControllerMuteUserBodyDurationMinutes = {
  NUMBER_1: 1,
  NUMBER_5: 5,
  NUMBER_10: 10,
} as const;
