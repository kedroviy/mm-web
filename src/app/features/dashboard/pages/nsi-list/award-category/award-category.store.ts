...
export const AwardCategoryStore = signalStore(
  { providedIn: 'root' },
  withState(initialState),
  withMethods((
    store,
    awardCategoryService = inject(NsiAwardcategoryService),
      ...
      awardCategoryService
        ...
        .pipe(
          ...
          switchMap((res: unknown) => {
            ...
            return progressService.connect(`/api/v1/nsi/awardCategory/import-progress/${jobId}`).pipe(
              tap((event) => {
                patchState(store, {
