...
export class UsersService {
   ...
   */
  usersControllerCreateUser<TData = RedisUserResponseDto>(createRedisUserDto: CreateRedisUserDto, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  usersControllerCreateUser<TData = RedisUserResponseDto>(createRedisUserDto: CreateRedisUserDto, options?: HttpClientOptions & {
    observe: 'events'
   ...
   */
  usersControllerGetProfile<TData = UserProfileResponseDto>(options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  usersControllerGetProfile<TData = UserProfileResponseDto>(options?: HttpClientOptions & {
    observe: 'events'
   ...
   */
  usersControllerGetAllUsers<TData = UserResponseDto[]>(params?: DeepNonNullable<UsersControllerGetAllUsersParams>, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  usersControllerGetAllUsers<TData = UserResponseDto[]>(params?: DeepNonNullable<UsersControllerGetAllUsersParams>, options?: HttpClientOptions & {
    observe: 'events'
  ...
  usersControllerGetAllUsers<TData = UserResponseDto[]>(
    params?: DeepNonNullable<UsersControllerGetAllUsersParams>, options?: HttpClientOptions & {
      observe?: any
    }): Observable<any> {
    return this.http.get<TData>(
      `/api/v1/users/all`, {
   ...
   */
  usersControllerGetUser<TData = RedisUserResponseDto>(userId: string | undefined | null, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  usersControllerGetUser<TData = RedisUserResponseDto>(userId: string | undefined | null, options?: HttpClientOptions & {
    observe: 'events'
   ...
   * @summary Delete user
   */
  usersControllerDeleteUser<TData = void>(userId: string | undefined | null, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  usersControllerDeleteUser<TData = void>(userId: string | undefined | null, options?: HttpClientOptions & {
    observe: 'events'
  ...
  usersControllerUpdateName<TData = RedisUserResponseDto>(userId: string | undefined | null,
                                                          usersControllerUpdateNameBody: UsersControllerUpdateNameBody, options?: HttpClientOptions & {
      observe?: 'body'
    }): Observable<TData>;
  usersControllerUpdateName<TData = RedisUserResponseDto>(userId: string | undefined | null,
                                                          usersControllerUpdateNameBody: UsersControllerUpdateNameBody, options?: HttpClientOptions & {
