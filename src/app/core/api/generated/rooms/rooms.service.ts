...
export class RoomsService {
   ...
   */
  roomsControllerCreateRoom<TData = RoomsControllerCreateRoom201>(createRoomDto?: CreateRoomDto, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  roomsControllerCreateRoom<TData = RoomsControllerCreateRoom201>(createRoomDto?: CreateRoomDto, options?: HttpClientOptions & {
    observe: 'events'
   ...
   */
  roomsControllerGetMyRooms<TData = RoomResponseDto[]>(options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  roomsControllerGetMyRooms<TData = RoomResponseDto[]>(options?: HttpClientOptions & {
    observe: 'events'
   ...
   */
  roomsControllerGetRoom<TData = RoomResponseDto>(id: string | undefined | null, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  roomsControllerGetRoom<TData = RoomResponseDto>(id: string | undefined | null, options?: HttpClientOptions & {
    observe: 'events'
   ...
   */
  roomsControllerJoinRoom<TData = RoomResponseDto>(joinRoomDto: JoinRoomDto, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  roomsControllerJoinRoom<TData = RoomResponseDto>(joinRoomDto: JoinRoomDto, options?: HttpClientOptions & {
    observe: 'events'
  ...
  roomsControllerLeaveRoom<TData = RoomResponseDto>(id: string | undefined | null,
                                                    roomsControllerLeaveRoomBody: RoomsControllerLeaveRoomBody, options?: HttpClientOptions & {
      observe?: 'body'
    }): Observable<TData>;
  roomsControllerLeaveRoom<TData = RoomResponseDto>(id: string | undefined | null,
                                                    roomsControllerLeaveRoomBody: RoomsControllerLeaveRoomBody, options?: HttpClientOptions & {
  ...
  roomsControllerChooseMovie<TData = RoomResponseDto>(id: string | undefined | null,
                                                      roomsControllerChooseMovieBody: RoomsControllerChooseMovieBody, options?: HttpClientOptions & {
      observe?: 'body'
    }): Observable<TData>;
  roomsControllerChooseMovie<TData = RoomResponseDto>(id: string | undefined | null,
                                                      roomsControllerChooseMovieBody: RoomsControllerChooseMovieBody, options?: HttpClientOptions & {
   ...
   */
  roomsControllerGetRoomMembers<TData = RoomMembersResponseDto>(id: string | undefined | null, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  roomsControllerGetRoomMembers<TData = RoomMembersResponseDto>(id: string | undefined | null, options?: HttpClientOptions & {
    observe: 'events'
  ...
  roomsControllerRemoveUserFromRoom<TData = RoomResponseDto>(id: string | undefined | null,
                                                             userId: string | undefined | null, options?: HttpClientOptions & {
      observe?: 'body'
    }): Observable<TData>;
  roomsControllerRemoveUserFromRoom<TData = RoomResponseDto>(id: string | undefined | null,
                                                             userId: string | undefined | null, options?: HttpClientOptions & {
   ...
   */
  roomsControllerGetChatHistory<TData = RoomsControllerGetChatHistory200>(id: string | undefined | null, options?: HttpClientOptions & {
    observe?: 'body'
  }): Observable<TData>;
  roomsControllerGetChatHistory<TData = RoomsControllerGetChatHistory200>(id: string | undefined | null, options?: HttpClientOptions & {
    observe: 'events'
  ...
  roomsControllerMuteUser<TData = RoomResponseDto>(id: string | undefined | null,
                                                   ...
                                                   roomsControllerMuteUserBody: RoomsControllerMuteUserBody, options?: HttpClientOptions & {
      observe?: 'body'
    }): Observable<TData>;
  roomsControllerMuteUser<TData = RoomResponseDto>(id: string | undefined | null,
                                                   userId: string | undefined | null,
