...
export class Service {
  ...
  genresControllerGetInfinite<TData = unknown>(
    params?: DeepNonNullable<GenresControllerGetInfiniteParams>,
  ...
  genresControllerGetInfinite<TData = unknown>(
    ...
    return this.http.get<TData>(`/api/v1/nsi/genres/get-infinity`, {
      ...options,
   ...
   */
  genresControllerGetWithPages<TData = unknown>(
    params?: DeepNonNullable<GenresControllerGetWithPagesParams>,
    options?: HttpClientOptions & {
      observe?: 'body';
    },
  ): Observable<TData>;
  ...
  genresControllerGetWithPages<TData = unknown>(
    ...
    return this.http.get<TData>(`/api/v1/nsi/genres/get-by-param`, {
      ...options,
      params: customParamsSerializer({ ...params, ...options?.params }),
    });
  }
   ...
   */
  genresControllerFindOne<TData = void>(
  ...
  genresControllerFindOne<TData = void>(
    ...
    return this.http.get<TData>(`/api/v1/nsi/genres/${id}`, options);
  }
  ...
  genresControllerUpdate<TData = void>(
    ...
    return this.http.patch<TData>(`/api/v1/nsi/genres/${id}`, updateGenreDto, options);
  }
  ...
  genresControllerRemove<TData = void>(
    ...
    return this.http.delete<TData>(`/api/v1/nsi/genres/${id}`, options);
  }

  /**
   * @summary Создать новый жанр
   */
  genresControllerCreate<TData = void>(
  ...
  genresControllerCreate<TData = void>(
    ...
    return this.http.post<TData>(`/api/v1/nsi/genres`, createGenreDto, options);
  }
}

export type GenresControllerGetInfiniteClientResult = NonNullable<unknown>;
export type GenresControllerGetWithPagesClientResult = NonNullable<unknown>;
export type GenresControllerFindOneClientResult = NonNullable<void>;
...
export type GenresControllerCreateClientResult = NonNullable<void>;
