 ...
 */
import type { RoomMembersResponseDtoMembersItem } from './roomMembersResponseDtoMembersItem';

export interface RoomMembersResponseDto {
  /** List of room members with their roles and names */
  members: RoomMembersResponseDtoMembersItem[];
}
